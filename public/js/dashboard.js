...
const addressTooltipTriggers = document.querySelectorAll(".address-tooltip-trigger");
const sizesTooltipTriggers = document.querySelectorAll('.sizes-tooltip-trigger');
const moreinfoTooltipTriggers = document.querySelectorAll('.moreinfo-tooltip-trigger');



    addressTooltipTriggers.forEach(function (trigger) {
    ...
    sizesTooltipTriggers.forEach(function (trigger) {
        const tooltip = new bootstrap.Tooltip(trigger, {
            title: () => {
    ...
    moreinfoTooltipTriggers.forEach(function (trigger){
        const tooltip = new bootstrap.Tooltip(trigger, {
            title: () => {
