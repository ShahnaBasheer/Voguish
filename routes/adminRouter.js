...
const { addProduct, getProduct, getAllProducts,
        ...
        getEditProduct } = require('../controllers/productController');
const { getDashboard, getAdminLogin} = require('../controllers/pageController');
const { getAllBrands, getAddBrand, addBrand,
        editBrand, deleteBrand, getEditBrand } = require('../controllers/brandController');
const { getAllCategories, getAddCategory, addCategory,
        editCategory, deleteCategory, getEditCategory } = require('../controllers/categoryContoller');
const { getCartList } = require('../controllers/cartController');
const { getOrders, orderDetails } = require('../controllers/ordersController');
